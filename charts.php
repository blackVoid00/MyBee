    ...
    <div id="content-wrapper" class="d-flex flex-column">
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
         ...
         <h2 align="center" style="font-weight: bold">Graphe de Temperature</h2>
            ...
            <div id="containerdiv">
            <iframe width="500" height="260" style="border: 1px solid #cccccc;" src="https://thingspeak.com/channels/1655736/charts/1?bgcolor=%23ffffff&color=%23d62020&dynamic=true&results=60&type=line"></iframe>  
        ...
        var tab=[];
        var tab2=[];
      const api_url = 'https://api.thingspeak.com/channels/1655736/fields/1.json?results';
      async function getLevel() {
        const response = await fetch(api_url);
        const data = await response.json();
  
document.getElementById('level').textContent = data['feeds'][cpt]['field1']
