    ...
    <div id="content-wrapper" class="d-flex flex-column">
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
         ...
         <h2 align="center" style="font-weight: bold">Graphe de luminosité</h2>
         <div >
            <p > Time: <span id="time"></span><br/>  Level: <span id="level"></span><br /></p>
            
            </div>
    <div id="containerdiv">
    <iframe width="450" height="260" style="border: 1px solid #cccccc;" src="https://thingspeak.com/channels/1655736/charts/3?bgcolor=%23ffffff&color=%23d62020&dynamic=true&results=60&type=line"></iframe>  
    </div>
       ...
       var cpt=0; 
        var tab=[];
        var tab2=[];
      const api_url = 'https://api.thingspeak.com/channels/1655736/fields/3.json?results';
      async function getLevel() {
        const response = await fetch(api_url);
        const data = await response.json();
       
        if(data['feeds'][cpt]['field3']==null){
            data['feeds'][cpt]['field3']=0
            document.getElementById('level').textContent = data['feeds'][cpt]['field3']
           document.getElementById('time').textContent = data['feeds'][cpt]['created_at']
           cpt++;
        }
